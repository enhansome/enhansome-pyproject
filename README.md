...
* [pytest-env](https://github.com/pytest-dev/pytest-env) ⭐ 233 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - A pytest plugin that enables you to set environment variables in a pyproject.toml file.
...
* [YAPF](https://github.com/google/yapf#excluding-files-from-formatting-yapfignore-or-pyprojecttoml) ⭐ 13,979 | 🐛 419 | 🌐 Python | 📅 2026-08-21 - A formatter for Python files.
...
* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 952 | 🐛 41 | 🌐 Python | 📅 2026-08-22 - Removes unused imports and unused variables as reported by pyflakes.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,596 | 🐛 335 | 🌐 Python | 📅 2026-08-22 - Static type checker for Python.
* [Vulture](https://github.com/jendrikseipp/vulture/blob/master/README.md#configuration) ⭐ 4,770 | 🐛 70 | 🌐 Python | 📅 2026-04-30 - Finds unused code in Python programs.
...
* [deptry](https://github.com/fpgmaas/deptry) ⭐ 1,464 | 🐛 61 | 🌐 Python | 📅 2026-08-22 - A command line tool to check for issues with dependencies in a Python project, such as obsolete or missing dependencies.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,769 | 🐛 54 | 🌐 Rust | 📅 2026-08-17 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
...
* [PyScaffold](https://github.com/pyscaffold/pyscaffold) ⭐ 2,263 | 🐛 37 | 🌐 Python | 📅 2026-08-17 - Python project template generator with batteries included.
...
* [Poe the Poet](https://github.com/nat-n/poethepoet#define-tasks-in-your-pyprojecttoml) ⭐ 2,062 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - A task runner that works well with Poetry.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,041 | 🐛 56 | 🌐 Shell | 📅 2026-08-16 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,375 | 🐛 390 | 🌐 Python | 📅 2026-08-22 - Read the Docs hosts documentation for the open source community.
* [AWS SAM](https://github.com/awslabs/aws-sam-cli/issues/1366) ⭐ 6,730 | 🐛 537 | 🌐 Python | 📅 2026-08-21 - CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
* [pycodestyle](https://github.com/PyCQA/pycodestyle/issues/813) ⭐ 5,163 | 🐛 105 | 🌐 Python | 📅 2026-08-16 - A tool to check your Python code against some of the style conventions in PEP 8.
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,109 | 🐛 1,790 | 🌐 Python | 📅 2026-08-22 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
* [pytype](https://github.com/google/pytype/issues/645) ⭐ 5,030 | 🐛 5 | 🌐 Python | 📅 2026-03-16 - A static type analyzer for Python code.
* [Invoke](https://github.com/pyinvoke/invoke/issues/537) ⭐ 4,767 | 🐛 459 | 🌐 Python | 📅 2026-04-07 - Library for managing shell-oriented subprocesses and organizing executable Python code into CLI-invokable tasks.
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,335 | 🐛 127 | 🌐 Python | 📅 2026-08-14 - A database migrations tool for SQLAlchemy.
* [flake8](https://github.com/PyCQA/flake8/issues/234) ⭐ 3,816 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - A python tool that glues together pep8, pyflakes, mccabe, and third-party plugins to check the style and quality of some python code.
* [prospector](https://github.com/PyCQA/prospector/issues/376) ⭐ 2,087 | 🐛 32 | 🌐 Python | 📅 2026-08-22 - A tool to analyse Python code and output information about errors, potential problems, convention violations and complexity.
...
* [Briefcase Bootstrap Template](https://github.com/beeware/briefcase-template/pull/16) ⭐ 49 | 🐛 2 | 🌐 Python | 📅 2026-08-02 - A template for starting a Python app that will be deployed using briefcase.
