...
* [pytest-env](https://github.com/pytest-dev/pytest-env) ⭐ 234 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - A pytest plugin that enables you to set environment variables in a pyproject.toml file.
...
* [YAPF](https://github.com/google/yapf#excluding-files-from-formatting-yapfignore-or-pyprojecttoml) ⭐ 13,984 | 🐛 417 | 🌐 Python | 📅 2026-08-28 - A formatter for Python files.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,614 | 🐛 328 | 🌐 Python | 📅 2026-09-02 - Static type checker for Python.
* [Vulture](https://github.com/jendrikseipp/vulture/blob/master/README.md#configuration) ⭐ 4,790 | 🐛 71 | 🌐 Python | 📅 2026-04-30 - Finds unused code in Python programs.
...
* [deptry](https://github.com/fpgmaas/deptry) ⭐ 1,471 | 🐛 65 | 🌐 Python | 📅 2026-09-01 - A command line tool to check for issues with dependencies in a Python project, such as obsolete or missing dependencies.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,780 | 🐛 55 | 🌐 Rust | 📅 2026-08-31 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
* [Pyflow](https://github.com/David-OConnor/pyflow) ⭐ 1,339 | 🐛 62 | 🌐 Rust | 📅 2026-03-21 - An installation and dependency system for Python.
* [setuptools\_scm](https://github.com/pypa/setuptools_scm) ⭐ 952 | 🐛 24 | 🌐 Python | 📅 2026-09-02 - Handles managing your Python package versions in SCM metadata instead of declaring them as the version argument or in a SCM managed file.
...
* [PyPA Sample Project](https://github.com/pypa/sampleproject) ⭐ 5,242 | 🐛 24 | 🌐 Python | 📅 2024-11-06 - A sample project that exists for PyPUG's "Tutorial on Packaging and Distributing Projects".
...
* [Hypermodern Cookiecutter](https://github.com/cjolowicz/cookiecutter-hypermodern-python) ⭐ 1,923 | 🐛 105 | 🌐 Python | 📅 2024-05-18 - Cookiecutter template for a Python package based on the [Hypermodern Python](https://cjolowicz.github.io/posts/hypermodern-python-01-setup/) article series.
...
* [wemake-python-package](https://github.com/wemake-services/wemake-python-package) ⭐ 445 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Bleeding edge cookiecutter template to create new python packages.
...
* [Poe the Poet](https://github.com/nat-n/poethepoet#define-tasks-in-your-pyprojecttoml) ⭐ 2,068 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - A task runner that works well with Poetry.
* [towncrier](https://github.com/twisted/towncrier) ⭐ 919 | 🐛 70 | 🌐 Python | 📅 2026-08-23 - A utility to produce useful, summarised news files for your project.
...
* [Autohooks](https://github.com/greenbone/autohooks/blob/master/README.md#1-choosing-an-autohooks-mode) ⭐ 206 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Library for managing git hooks.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,066 | 🐛 55 | 🌐 Shell | 📅 2026-09-02 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,380 | 🐛 387 | 🌐 Python | 📅 2026-09-02 - Read the Docs hosts documentation for the open source community.
* [AWS SAM](https://github.com/awslabs/aws-sam-cli/issues/1366) ⭐ 6,733 | 🐛 534 | 🌐 Python | 📅 2026-09-02 - CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
* [PyOxidizer](https://github.com/indygreg/PyOxidizer/issues/93) ⭐ 6,151 | 🐛 362 | 🌐 Rust | 📅 2024-12-24 - A modern Python application packaging and distribution tool.
...
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,116 | 🐛 1,805 | 🌐 Python | 📅 2026-09-02 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
* [pytype](https://github.com/google/pytype/issues/645) ⭐ 5,031 | 🐛 5 | 🌐 Python | 📅 2026-03-16 - A static type analyzer for Python code.
* [Invoke](https://github.com/pyinvoke/invoke/issues/537) ⭐ 4,774 | 🐛 461 | 🌐 Python | 📅 2026-04-07 - Library for managing shell-oriented subprocesses and organizing executable Python code into CLI-invokable tasks.
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,363 | 🐛 127 | 🌐 Python | 📅 2026-09-02 - A database migrations tool for SQLAlchemy.
* [flake8](https://github.com/PyCQA/flake8/issues/234) ⭐ 3,825 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - A python tool that glues together pep8, pyflakes, mccabe, and third-party plugins to check the style and quality of some python code.
* [prospector](https://github.com/PyCQA/prospector/issues/376) ⭐ 2,087 | 🐛 32 | 🌐 Python | 📅 2026-08-31 - A tool to analyse Python code and output information about errors, potential problems, convention violations and complexity.
* [Radon](https://github.com/rubik/radon/issues/220) ⭐ 2,014 | 🐛 52 | 🌐 Python | 📅 2024-10-20 - A Python tool that computes various metrics from the source code.
...
* [pytest-benchmark](https://github.com/ionelmc/pytest-benchmark/issues/26) ⭐ 1,448 | 🐛 119 | 🌐 Python | 📅 2026-08-23 - A pytest fixture for benchmarking code.
...
* [nose2](https://github.com/nose-devs/nose2/issues/452) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-08-31 - The successor to nose. Its purpose is to extend unittest to make testing nicer and easier to understand.
...
* [Briefcase Bootstrap Template](https://github.com/beeware/briefcase-template/pull/16) ⭐ 49 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - A template for starting a Python app that will be deployed using briefcase.
