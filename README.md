...
* [pytest-env](https://github.com/pytest-dev/pytest-env) ⭐ 235 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - A pytest plugin that enables you to set environment variables in a pyproject.toml file.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,626 | 🐛 337 | 🌐 Python | 📅 2026-09-08 - Static type checker for Python.
* [Vulture](https://github.com/jendrikseipp/vulture/blob/master/README.md#configuration) ⭐ 4,800 | 🐛 71 | 🌐 Python | 📅 2026-04-30 - Finds unused code in Python programs.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,785 | 🐛 55 | 🌐 Rust | 📅 2026-09-07 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
...
* [PyScaffold](https://github.com/pyscaffold/pyscaffold) ⭐ 2,262 | 🐛 37 | 🌐 Python | 📅 2026-08-31 - Python project template generator with batteries included.
...
* [towncrier](https://github.com/twisted/towncrier) ⭐ 919 | 🐛 68 | 🌐 Python | 📅 2026-09-08 - A utility to produce useful, summarised news files for your project.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,085 | 🐛 55 | 🌐 Shell | 📅 2026-09-08 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,385 | 🐛 395 | 🌐 Python | 📅 2026-09-08 - Read the Docs hosts documentation for the open source community.
* [AWS SAM](https://github.com/awslabs/aws-sam-cli/issues/1366) ⭐ 6,732 | 🐛 529 | 🌐 Python | 📅 2026-09-08 - CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,119 | 🐛 1,805 | 🌐 Python | 📅 2026-09-08 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
* [pytype](https://github.com/google/pytype/issues/645) ⚠️ Archived - A static type analyzer for Python code.
* [Invoke](https://github.com/pyinvoke/invoke/issues/537) ⭐ 4,776 | 🐛 461 | 🌐 Python | 📅 2026-04-07 - Library for managing shell-oriented subprocesses and organizing executable Python code into CLI-invokable tasks.
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,379 | 🐛 120 | 🌐 Python | 📅 2026-09-08 - A database migrations tool for SQLAlchemy.
...
* [prospector](https://github.com/PyCQA/prospector/issues/376) ⭐ 2,086 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - A tool to analyse Python code and output information about errors, potential problems, convention violations and complexity.
...
* [pytest-benchmark](https://github.com/ionelmc/pytest-benchmark/issues/26) ⭐ 1,450 | 🐛 121 | 🌐 Python | 📅 2026-08-23 - A pytest fixture for benchmarking code.
