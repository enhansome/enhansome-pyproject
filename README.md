...
* [YAPF](https://github.com/google/yapf#excluding-files-from-formatting-yapfignore-or-pyprojecttoml) ⭐ 13,988 | 🐛 420 | 🌐 Python | 📅 2026-08-28 - A formatter for Python files.
...
* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 953 | 🐛 43 | 🌐 Python | 📅 2026-08-23 - Removes unused imports and unused variables as reported by pyflakes.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,648 | 🐛 338 | 🌐 Python | 📅 2026-09-18 - Static type checker for Python.
...
* [deptry](https://github.com/fpgmaas/deptry) ⭐ 1,482 | 🐛 68 | 🌐 Python | 📅 2026-09-18 - A command line tool to check for issues with dependencies in a Python project, such as obsolete or missing dependencies.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,809 | 🐛 53 | 🌐 Rust | 📅 2026-09-16 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
...
* [PyScaffold](https://github.com/pyscaffold/pyscaffold) ⭐ 2,260 | 🐛 37 | 🌐 Python | 📅 2026-08-31 - Python project template generator with batteries included.
...
* [Poe the Poet](https://github.com/nat-n/poethepoet#define-tasks-in-your-pyprojecttoml) ⭐ 2,076 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - A task runner that works well with Poetry.
...
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,125 | 🐛 1,815 | 🌐 Python | 📅 2026-09-18 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
...
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,402 | 🐛 117 | 🌐 Python | 📅 2026-09-18 - A database migrations tool for SQLAlchemy.
...
* [prospector](https://github.com/PyCQA/prospector/issues/376) ⭐ 2,083 | 🐛 32 | 🌐 Python | 📅 2026-09-14 - A tool to analyse Python code and output information about errors, potential problems, convention violations and complexity.
* [Radon](https://github.com/rubik/radon/issues/220) ⭐ 2,027 | 🐛 52 | 🌐 Python | 📅 2024-10-20 - A Python tool that computes various metrics from the source code.
