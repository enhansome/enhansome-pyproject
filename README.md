...
* [YAPF](https://github.com/google/yapf#excluding-files-from-formatting-yapfignore-or-pyprojecttoml) ⭐ 13,980 | 🐛 419 | 🌐 Python | 📅 2026-08-14 - A formatter for Python files.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,589 | 🐛 327 | 🌐 Python | 📅 2026-08-17 - Static type checker for Python.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,759 | 🐛 53 | 🌐 Rust | 📅 2026-08-17 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
...
* [Poe the Poet](https://github.com/nat-n/poethepoet#define-tasks-in-your-pyprojecttoml) ⭐ 2,059 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - A task runner that works well with Poetry.
* [towncrier](https://github.com/twisted/towncrier) ⭐ 914 | 🐛 71 | 🌐 Python | 📅 2026-08-15 - A utility to produce useful, summarised news files for your project.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,023 | 🐛 56 | 🌐 Shell | 📅 2026-08-16 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,375 | 🐛 389 | 🌐 Python | 📅 2026-08-17 - Read the Docs hosts documentation for the open source community.
* [AWS SAM](https://github.com/awslabs/aws-sam-cli/issues/1366) ⭐ 6,728 | 🐛 537 | 🌐 Python | 📅 2026-08-17 - CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,107 | 🐛 1,786 | 🌐 Python | 📅 2026-08-17 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
...
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,325 | 🐛 128 | 🌐 Python | 📅 2026-08-14 - A database migrations tool for SQLAlchemy.
* [flake8](https://github.com/PyCQA/flake8/issues/234) ⭐ 3,814 | 🐛 23 | 🌐 Python | 📅 2026-08-16 - A python tool that glues together pep8, pyflakes, mccabe, and third-party plugins to check the style and quality of some python code.
...
* [pytest-benchmark](https://github.com/ionelmc/pytest-benchmark/issues/26) ⭐ 1,446 | 🐛 123 | 🌐 Python | 📅 2026-06-16 - A pytest fixture for benchmarking code.
