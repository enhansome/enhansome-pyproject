...
* [pytest-env](https://github.com/pytest-dev/pytest-env) ⭐ 235 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A pytest plugin that enables you to set environment variables in a pyproject.toml file.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,624 | 🐛 342 | 🌐 Python | 📅 2026-09-04 - Static type checker for Python.
* [Vulture](https://github.com/jendrikseipp/vulture/blob/master/README.md#configuration) ⭐ 4,797 | 🐛 71 | 🌐 Python | 📅 2026-04-30 - Finds unused code in Python programs.
...
* [deptry](https://github.com/fpgmaas/deptry) ⭐ 1,473 | 🐛 68 | 🌐 Python | 📅 2026-09-07 - A command line tool to check for issues with dependencies in a Python project, such as obsolete or missing dependencies.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,784 | 🐛 55 | 🌐 Rust | 📅 2026-09-07 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
...
* [Hypermodern Cookiecutter](https://github.com/cjolowicz/cookiecutter-hypermodern-python) ⭐ 1,919 | 🐛 105 | 🌐 Python | 📅 2024-05-18 - Cookiecutter template for a Python package based on the [Hypermodern Python](https://cjolowicz.github.io/posts/hypermodern-python-01-setup/) article series.
...
* [towncrier](https://github.com/twisted/towncrier) ⭐ 919 | 🐛 69 | 🌐 Python | 📅 2026-09-07 - A utility to produce useful, summarised news files for your project.
...
* [Autohooks](https://github.com/greenbone/autohooks/blob/master/README.md#1-choosing-an-autohooks-mode) ⭐ 206 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Library for managing git hooks.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,084 | 🐛 55 | 🌐 Shell | 📅 2026-09-06 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,384 | 🐛 394 | 🌐 Python | 📅 2026-09-07 - Read the Docs hosts documentation for the open source community.
* [AWS SAM](https://github.com/awslabs/aws-sam-cli/issues/1366) ⭐ 6,732 | 🐛 528 | 🌐 Python | 📅 2026-09-07 - CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
...
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,119 | 🐛 1,809 | 🌐 Python | 📅 2026-09-07 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
...
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,374 | 🐛 127 | 🌐 Python | 📅 2026-09-04 - A database migrations tool for SQLAlchemy.
...
* [prospector](https://github.com/PyCQA/prospector/issues/376) ⭐ 2,087 | 🐛 33 | 🌐 Python | 📅 2026-09-07 - A tool to analyse Python code and output information about errors, potential problems, convention violations and complexity.
...
* [pytest-benchmark](https://github.com/ionelmc/pytest-benchmark/issues/26) ⭐ 1,449 | 🐛 121 | 🌐 Python | 📅 2026-08-23 - A pytest fixture for benchmarking code.
...
* [nose2](https://github.com/nose-devs/nose2/issues/452) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-09-07 - The successor to nose. Its purpose is to extend unittest to make testing nicer and easier to understand.
