...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,775 | 🐛 53 | 🌐 Rust | 📅 2026-08-24 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,056 | 🐛 54 | 🌐 Shell | 📅 2026-08-28 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,379 | 🐛 391 | 🌐 Python | 📅 2026-08-28 - Read the Docs hosts documentation for the open source community.
...
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,353 | 🐛 128 | 🌐 Python | 📅 2026-08-14 - A database migrations tool for SQLAlchemy.
