...
* [YAPF](https://github.com/google/yapf#excluding-files-from-formatting-yapfignore-or-pyprojecttoml) ⭐ 13,985 | 🐛 419 | 🌐 Python | 📅 2026-08-28 - A formatter for Python files.
...
* [Pyright](https://github.com/microsoft/pyright/blob/1.1.200/docs/configuration.md#sample-pyprojecttoml-file) ⭐ 15,622 | 🐛 340 | 🌐 Python | 📅 2026-09-04 - Static type checker for Python.
* [Vulture](https://github.com/jendrikseipp/vulture/blob/master/README.md#configuration) ⭐ 4,795 | 🐛 71 | 🌐 Python | 📅 2026-04-30 - Finds unused code in Python programs.
...
* [deptry](https://github.com/fpgmaas/deptry) ⭐ 1,472 | 🐛 68 | 🌐 Python | 📅 2026-09-06 - A command line tool to check for issues with dependencies in a Python project, such as obsolete or missing dependencies.
...
* [Maturin](https://github.com/PyO3/maturin/blob/main/README.md#python-metadata) ⭐ 5,782 | 🐛 55 | 🌐 Rust | 📅 2026-08-31 - Build and publish crates with pyo3, rust-cpython and cffi bindings as well as rust binaries as python packages.
* [Pyflow](https://github.com/David-OConnor/pyflow) ⭐ 1,339 | 🐛 62 | 🌐 Rust | 📅 2026-03-21 - An installation and dependency system for Python.
* [setuptools\_scm](https://github.com/pypa/setuptools_scm) ⭐ 952 | 🐛 22 | 🌐 Python | 📅 2026-09-04 - Handles managing your Python package versions in SCM metadata instead of declaring them as the version argument or in a SCM managed file.
...
* [PyPA Sample Project](https://github.com/pypa/sampleproject) ⭐ 5,239 | 🐛 24 | 🌐 Python | 📅 2024-11-06 - A sample project that exists for PyPUG's "Tutorial on Packaging and Distributing Projects".
...
* [wemake-python-package](https://github.com/wemake-services/wemake-python-package) ⭐ 446 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Bleeding edge cookiecutter template to create new python packages.
...
* [Poe the Poet](https://github.com/nat-n/poethepoet#define-tasks-in-your-pyprojecttoml) ⭐ 2,070 | 🐛 13 | 🌐 Python | 📅 2026-07-12 - A task runner that works well with Poetry.
* [towncrier](https://github.com/twisted/towncrier) ⭐ 919 | 🐛 68 | 🌐 Python | 📅 2026-09-04 - A utility to produce useful, summarised news files for your project.
...
* [pyenv](https://github.com/pyenv/pyenv/issues/1233) ⭐ 45,081 | 🐛 54 | 🌐 Shell | 📅 2026-09-06 - Simple Python version management.
* [readthedocs.org](https://github.com/readthedocs/readthedocs.org/issues/7065) ⭐ 8,384 | 🐛 389 | 🌐 Python | 📅 2026-09-06 - Read the Docs hosts documentation for the open source community.
* [AWS SAM](https://github.com/awslabs/aws-sam-cli/issues/1366) ⭐ 6,732 | 🐛 524 | 🌐 Python | 📅 2026-09-04 - CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM.
* [PyOxidizer](https://github.com/indygreg/PyOxidizer/issues/93) ⭐ 6,153 | 🐛 362 | 🌐 Rust | 📅 2024-12-24 - A modern Python application packaging and distribution tool.
...
* [Spack](https://github.com/spack/spack/issues/6629) ⭐ 5,118 | 🐛 1,805 | 🌐 Python | 📅 2026-09-04 - A flexible package manager that supports multiple versions, configurations, platforms, and compilers.
* [pytype](https://github.com/google/pytype/issues/645) ⚠️ Archived - A static type analyzer for Python code.
* [Invoke](https://github.com/pyinvoke/invoke/issues/537) ⭐ 4,775 | 🐛 461 | 🌐 Python | 📅 2026-04-07 - Library for managing shell-oriented subprocesses and organizing executable Python code into CLI-invokable tasks.
* [Alembic](https://github.com/sqlalchemy/alembic/issues/708) ⭐ 4,371 | 🐛 127 | 🌐 Python | 📅 2026-09-04 - A database migrations tool for SQLAlchemy.
...
* [Radon](https://github.com/rubik/radon/issues/220) ⭐ 2,017 | 🐛 52 | 🌐 Python | 📅 2024-10-20 - A Python tool that computes various metrics from the source code.
...
* [pytest-benchmark](https://github.com/ionelmc/pytest-benchmark/issues/26) ⭐ 1,449 | 🐛 120 | 🌐 Python | 📅 2026-08-23 - A pytest fixture for benchmarking code.
...
* [Briefcase Bootstrap Template](https://github.com/beeware/briefcase-template/pull/16) ⭐ 49 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - A template for starting a Python app that will be deployed using briefcase.
